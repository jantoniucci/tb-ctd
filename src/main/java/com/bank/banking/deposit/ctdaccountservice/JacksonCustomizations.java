...
/**
 * Configures custom serialization and deserialization of {@link Money}
 * instances
 *
 */
...
class JacksonCustomizations {
    ...
    static class MoneyModule extends SimpleModule {
        ...
        /**
         * A dedicated serializer to render {@link MonetaryAmount} instances as
         * formatted {@link String}. Also implements
         * {@link JsonSchemaPropertyCustomizer} to expose the different rendering to the
         * schema exposed by Spring Data REST.
         *
         */
        static class MonetaryAmountSerializer extends StdSerializer<MonetaryAmount>
            ...
            static {
                ...
                builder.append("(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?"); // digits with optional grouping by "," every
                                                                           // 3)
             ...
             * (non-Javadoc)
             * 
             * @see org.springframework.data.rest.webmvc.json.JsonSchemaPropertyCustomizer#
             * customize(org.springframework.data.rest.webmvc.json.JsonSchema.
             * JsonSchemaProperty, org.springframework.data.util.TypeInformation)
             */
            @Override
        ...
        static class MoneyInstantiator extends ValueInstantiator {
             ...
             * 
             * @see
             * com.fasterxml.jackson.databind.deser.ValueInstantiator#createFromString(com.
             * fasterxml.jackson.databind.DeserializationContext, java.lang.String)
             */
            @Override
